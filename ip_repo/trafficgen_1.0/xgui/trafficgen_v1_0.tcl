...
proc update_PARAM_VALUE.NUM_OF_WORDS_WIDTH { PARAM_VALUE.NUM_OF_WORDS_WIDTH } {
	# Procedure called to update NUM_OF_WORDS_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NUM_OF_WORDS_WIDTH { PARAM_VALUE.NUM_OF_WORDS_WIDTH } {
	# Procedure called to validate NUM_OF_WORDS_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.NUM_OF_WORDS_WIDTH { MODELPARAM_VALUE.NUM_OF_WORDS_WIDTH PARAM_VALUE.NUM_OF_WORDS_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUM_OF_WORDS_WIDTH}] ${MODELPARAM_VALUE.NUM_OF_WORDS_WIDTH}
}
